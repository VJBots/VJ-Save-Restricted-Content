...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://hussenahmed143:htjs776644@cluster0.we7brrt.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
