...
API_ID = int(os.environ.get("API_ID", "26069847"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "ae19bdc8f9e4ab74c59ff41877379db7")
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://madanbudhamagar79_db_user:<U20jendycwG8xmRA>@cluster0.moc1aii.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
